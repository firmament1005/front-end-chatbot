        ...
        <div className="x-full border-t-2">
            <form>
                ...
                <div className="flex overflow-y-auto items-center py-2 px-3 bg-gray-50 rounded-lg">
                    ...
                    <textarea rows={textLineCount} ref={textareaRef} value={questionText} onChange={(e) => handleTextArea(e)} className="block mx-4 p-2.5 w-full max-h-100 min-h-11 text-sm text-black bg-white rounded border border-indigo-700 focus:border focus:border-indigo-700 dark:bg-gray-100 dark:border-indigo-700 dark:placeholder-black dark:text-black dark:focus:border-indigo-700 outline-none"
