    ...
    return (
        <div className="x-full">
            <form>
                ...
                <div className="flex items-center py-2 px-3 bg-gray-50 rounded-lg dark:bg-white-700">
                    <textarea rows={1} className="block mx-4 p-2.5 w-full max-h-11 min-h-11 text-sm text-black bg-white rounded-lg border border-[#0099FF] focus:ring-[#0099FF] focus:border-[#0099FF] dark:bg-gray-100 dark:border-[#0099FF] dark:placeholder-black dark:text-black dark:focus:border-[#0099FF] outline-none" placeholder="Your message..."></textarea>
