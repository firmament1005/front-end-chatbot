        ...
        <div className="flex h-screen">
            <aside className="flex flex-col items-center w-auto py-8 space-y-8 transition transform ease-in-out duration-1000 z-50 h-screen bg-white shadow">
                ...
                <div className="mini mt-20 flex flex-col space-y-3 w-full h-full relative">
                    <div className="justify-end pr-3 text-gray-600 dark:hover:text-blue-500 w-full bg-white p-3 rounded-full flex cursor-pointer" onClick={() => setIsSideBarType("ChatSideBar")}>
                    ...
                    <div className="justify-end pr-3 text-gray-600 dark:hover:text-blue-500 w-full bg-white p-3 rounded-full flex cursor-pointer" onClick={() => setIsSideBarType("UploadSideBar")}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                    ...
                    <div className="justify-end pr-3 text-gray-600 dark:hover:text-blue-500 w-full bg-white p-3 rounded-full flex cursor-pointer" onClick={() => setIsSideBarType("SettingSideBar")}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                            stroke="currentColor" className="w-5 h-5">
                    ...
                    <div className="justify-end pr-3 text-gray-600 dark:hover:text-blue-500 w-full bg-white p-3 rounded-full flex cursor-pointer">
            ...
            <SideBar sidebartype={isSideBarType} />
