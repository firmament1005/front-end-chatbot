    ...
    return (
        <aside className="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
            ...
            <div className="mini mt-20 flex flex-col space-y-3 w-full h-[calc(95vh)] relative">
                <div className="hover:ml-4 justify-end pr-4 text-white hover:text-purple-500 dark:hover:text-blue-500 w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
                ...
                <div className="justify-end pr-2 text-white w-full p-3 rounded-full flex absolute" style={{ "bottom": "60px" }}>
