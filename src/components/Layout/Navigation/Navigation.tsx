    ...
    return (
        <>
            <aside className="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
                ...
                <div className="mini mt-20 flex flex-col space-y-3 w-full h-[calc(95vh)] relative">
                    <div className="hover:ml-4 justify-end pr-3 text-white hover:text-purple-500 dark:hover:text-blue-500 w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
                    ...
                    <div className="justify-end pr-2 text-white w-full p-3 rounded-full flex absolute" style={{ "bottom": "60px" }} onClick={openModal}>
                        <button className="mt-2 rounded-full bg-gray-100">
                            <img className="h-8 w-8 rounded-full" src="https://avatars.githubusercontent.com/u/35387401?v=4" alt="" />
                        </button>
                    </div>
                </div>
            </aside>
