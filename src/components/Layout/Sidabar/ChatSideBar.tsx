            ...
            <div className="flex">
                <div className="w-64 absolute sm:relative bg-gray-100 shadow md:h-full flex-col justify-between hidden sm:flex">
                    <div className="px-8 h-screen item-center flex flex-col">
                        ...
                        <button className="group relative overflow-hidden bg-[#0099FF] cursor-pointer focus:ring-4 focus:ring-gray-300 inline-flex items-center px-4 py-2.5 mt-10 rounded-lg text-white justify-center" onClick={() => setIsBotModal(true)}>
                ...
                <div className="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between transition duration-150 ease-in-out"
                    id="mobile-nav" style={{
                    ...
                    <button aria-label="toggle sidebar" id="openSideBar" onClick={() => sidebarHandler(true)}
                        className={!isSidebarOpen ? 'hidden h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800' : 'hidden'}>
