        ...
        <div className="w-64 absolute sm:relative bg-white-800 shadow border-x-2 md:h-full flex-col justify-between hidden sm:flex">
            <div className="px-8">
                <div className="h-16 w-full flex items-center">
                    <h1 className="flex w-full justify-between text-black-300 mt-20 cursor-pointer items-center mb-6 text-4xl font-semibold">チャット</h1>
                </div>
                <div className="flex justify-center mt-10 mb-4 w-full">
                    <div className="relative">
                        ...
                        <input className="bg-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm text-black-300 placeholder-gray-700 pl-10 py-2"
                            type="text" placeholder="検索" />
                    </div>
                </div>
                <ul className="mt-12">
                    <li className="flex w-full justify-between text-black-300 cursor-pointer items-center px-2.5 py-2.5 mb-6 hover:bg-gray-200">
